...
public class MainActivity extends FragmentActivity implements OnCheckedChangeListener{
	...
	public void onBackPressed() {
		long current_pressed_times = System.currentTimeMillis();
		//如果back_tiem值为0，则首次给它赋值
		if(back_pressed_time==0){
			back_pressed_time = current_pressed_times;
			Myapplication.toast("请再次按返回键");
		}else if((back_pressed_time!=0)&&(current_pressed_times-back_pressed_time<=1000)){
			super.onBackPressed();
		}else{
			//back_time重新赋值为0
			back_pressed_time = current_pressed_times;
